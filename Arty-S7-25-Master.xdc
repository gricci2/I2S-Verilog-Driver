...
## Switches
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports sready]
...
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports i2s_mclk]
set_property -dict {PACKAGE_PIN P13 IOSTANDARD LVCMOS33} [get_ports i2s_lrck]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports i2s_sclk]
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports i2s_sdout]
